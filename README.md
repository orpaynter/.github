...
Company GitHub face: [github.com/Orpaynter-Inc](https://github.com/Orpaynter-Inc).  
Founder login: [github.com/orpaynter](https://github.com/orpaynter).  
Public founder map (same index): [orpaynter/me](https://github.com/orpaynter/me).

Product in one line: **ClaimFlow** — intake → evidence-linked draft → human approval → locked Decision Package. AI drafts. You govern.
...
UI-TARS-desktop, browser-use, Auto-GPT, and other upstream clones stay on the founder account. They are tools, not OrPaynter products.
